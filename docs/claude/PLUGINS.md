...
| Hook | Evento | Ação |
|---|---|---|
| `~/.claude/hooks/guardian.py` | PreToolUse (Write/Edit/MultiEdit) | Bloqueia emojis e atribuições explícitas a IA (regras GUIDE.md #2 e #3) |
...
| `claude-md-management` | Gestão estruturada de `GUIDE.md` (seu é symlink pra AI.md — talvez skip) |
