...
A skill `validação-visual` e o protocolo `[VALIDAÇÃO VISUAL]` no AI.md §13 definem:
...
Path: `docs/claude/skills/validação-visual/SKILL.md`
...
1. Executor-sprint, após implementar, invoca skill `validação-visual` automaticamente se diff toca UI.
