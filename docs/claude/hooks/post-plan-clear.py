...
prestes a iniciar execução. Em vez de forcar /clear (destruiria contexto
...
edits" do Claude Code não aparece (bugs conhecidos #45034, #38071, #39665).
...
Filosofia: sutil, não-forca. Claude le a dica e decide.
"""
...
DICA = (
    ...
    "Esta dica não e obrigatoria - ignore se não aplicavel."
)
...
# "Sutileza > forca. Epicteto: 'não instrua pela repreensao mas pela conducta.'"
