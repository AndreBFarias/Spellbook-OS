...
# Uso: sincronizar_mec
alias sincronizar_mec='cd ~/Desenvolvimento/Projetos_segape/pipelines && git pull --rebase origin develop'
...
# Propósito: Entrar no projeto pipelines (branch padrão)
# Uso: mec
alias mec='santuario Projetos_segape pipelines'
# Propósito: Entrar no projeto pipelines na branch develop
# Uso: mec_dev
alias mec_dev='santuario Projetos_segape pipelines develop'
